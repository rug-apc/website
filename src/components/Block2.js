...
const Block2 = () => {
    ...
    return (
        <div className='center max auto max-width' >
            ...
            <div>
                <p className='title-block1'>Structure of the course</p>
            </div>
            ...
            <div>
                <div className='max flex'>
                    <div className='box center'>
                        <div>
                            <p className='title-info red'>Block 1</p>
                        </div>
                        <div className='block'>
                    ...
                    <div className='box center'>
                        <div>
                            <p className='title-info red'>Block 2</p>
                        </div>
                        <div>
                    ...
                    <div className='box' id='schedule'>
                        <div>
                            <p className='title-info red'>Block 3</p>
                        </div>
                        <div>
