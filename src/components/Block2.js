              ...
              <p className="description-info ">
                <ul className="list">
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <strong>26/09/26</strong> -- BAPC Prelims
                      </li>
                      <li>
              ...
              <p className="description-info block">
                <ul className="list">
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        <strong>25/11/26</strong> -- Internal Contest
                      </li>
                      <li>
                        <strong>27-29/11/26</strong> -- NWERC
                      </li>
                      <li>
                        <strong>09/12/26</strong> -- Internal Contest
                      </li>
                      <li>
                        <strong>06/01/26</strong> -- Internal Contest
                      </li>
                    </ul>
                  </li>
                </ul>
